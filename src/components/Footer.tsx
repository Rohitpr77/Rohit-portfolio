...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/Rohitpr77" },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/rohit-prajapati-93ba6522b/",
  },
  { label: "Email", href: "mailto:rohitpr7733@gmail.com" },
];
        ...
        >
          ...
          <div className="flex flex-col gap-4 max-w-xs">
            <div className="flex items-center gap-3">
              ...
              <img src={"my rr/rohit.png"} className="w-9 h-9 rounded-full flex items-center justify-center font-display font-extrabold text-xs" />
