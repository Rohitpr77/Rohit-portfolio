      ...
      <div className="main">
        <a href="#" target="_blank" rel="noopener noreferrer" className="card">
          <svg fillRule="nonzero" height="30px" width="30px" viewBox="0,0,256,256" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="instagram">
            <g style={{ mixBlendMode: 'normal' }} strokeDashoffset={0} strokeDasharray={""} strokeMiterlimit={10} strokeLinejoin="miter" strokeLinecap="butt" strokeWidth={1} stroke="none" fillRule="nonzero">
        ...
        <a href="https://github.com/Rohitpr77" target="_blank" rel="noopener noreferrer" className="card">
        ...
        <p className="text">CONNECT<br /><br />FOR<br /><br />SOCIAL</p>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="overflow-hidden border-y mb-16 select-none"
        style={{ borderColor: "rgba(255,255,255,0.05)", padding: "16px 0" }}
      >
        <div className="flex w-max animate-marquee">
          {[...marqueeItems, ...marqueeItems].map((item, i) => (
            <span
              key={i}
              className="flex-shrink-0 px-5 font-mono text-xs tracking-[0.22em] uppercase whitespace-nowrap"
              style={{
                color: item === "✦" ? "#e8ff47" : "rgba(255,255,255,0.2)",
              }}
            >
              {item}
            </span>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-10 md:gap-16 pb-12 border-b items-center "
        ...
        >
          ...
          <div className="flex flex-col gap-4 max-w-xs">
            <div className="flex items-center gap-3">
              {/* <div
                className="w-9 h-9 rounded-full flex items-center justify-center font-display font-extrabold text-xs"
                style={{ backgroundColor: "#e8ff47", color: "#0a0a0a" }}
              >
                
              </div> */}
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={"my rr/rohit.png"} alt="Rohit" className="w-9 h-9 rounded-full flex items-center justify-center font-display font-extrabold text-xs" />
              <span className="font-display font-bold text-text-pri tracking-wide">
                Rohit Prajapati
              </span>
            </div>
            <p className="text-xs text-text-sec font-light leading-relaxed">
              Full Stack Developer crafting scalable, performant web
              applications from Jhalawar, Rajasthan.
            </p>
          </div>
        ...
        >
          <p className="text-[10px] font-mono tracking-[0.2em] uppercase text-text-sec">
            © {new Date().getFullYear()} Rohit Prajapati — All rights reserved
          </p>
          <p className="text-[10px] font-mono tracking-[0.18em] uppercase text-text-sec">
            Designed &amp; Built with{" "}
            <span style={{ color: "#e8ff47" }}>Next.js</span> &amp;{" "}
            <span style={{ color: "#e8ff47" }}>Framer Motion</span>
          </p>
        </motion.div>
      </div>
    </footer>
